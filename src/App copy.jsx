...
const TargetCursor = ({
  ...
  const hexAngle = 30; // angle for subtler 3D effect
  ...
  return (
    <div className="meebits-orbital-container">
      ...
      {currentSectionIndex === 0 && (
        ...
        >
          <ProfileCard 
            avatarUrl="/src/assets/IMG_3641.jpeg"
            miniAvatarUrl="/src/assets/IMG_3641.jpeg"
      ...
      {currentSectionIndex !== 3 && currentSectionIndex !== 4 && (
        <div className="section-details" style={{
          left: currentSectionIndex === 0 ? '50%' : '720px',
          transform: currentSectionIndex === 0 ? 'translate(-50%, -50%)' : 'translate(-50%, -50%)'
        }}>
          <motion.div
            key={center.id}
...
const cardData = [
  {
    ...
    image: "/src/assets/constructionCalcSS.png",
  ...
  },
  {
    ...
    image: "/src/assets/galadeerSS.jpg",
  ...
  },
  {
    ...
    image: "/src/assets/severenceSS.png",
  ...
  },
  {
    ...
    image: "/src/assets/solitaireSS.jpg",
...
export default MeebitsPortfolio;
